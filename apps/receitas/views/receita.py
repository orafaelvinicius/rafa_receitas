...
def index(request):
    ...
    # Para escolher quantos posts deseja exibir por pagina (objeto, numero_de_posts)
    paginator = Paginator(receitas, 6)

    # Identificando a página que estou atualmente
    page = request.GET.get('page')

    # Definindo os posts quero por página,
    receitas_por_pagina = paginator.get_page(page)

    # Dicionário de dados à ser exibido na página
    dados = {
